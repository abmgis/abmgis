...
to setup-random
  clear-all
draw-gridlines ;;Procedure comes from http://complexityblog.com/blog/index.php?itemid=69
  ask patches
...
;;The draw-gridlines procedure was coppied exactly from http://complexityblog.com/blog/index.php?itemid=69
to draw-gridlines
  crt world-width [
    set ycor min-pycor
    set xcor who + .5

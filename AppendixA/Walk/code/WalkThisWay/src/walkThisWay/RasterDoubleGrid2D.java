...
public class RasterDoubleGrid2D extends DoubleGrid2D
{
  ...
  * @param seed
  */
  public RasterDoubleGrid2D (int width, int height, int initialValue)
  {
  ...
  //***************************************************************************
  /**This is a Raster Double Grid 2D class constructor.*/
  public RasterDoubleGrid2D(int width, int height)
  {
  ...
  //***************************************************************************
  /**This is a Raster Double Grid 2D class constructor.*/
  public RasterDoubleGrid2D(DoubleGrid2D values)
  {
  ...
  //***************************************************************************
  /**This is a Raster Double Grid 2D class constructor.*/
  public RasterDoubleGrid2D(RasterDoubleGrid2D values)
  {
  ...
  public void setHeader(final RasterDoubleGrid2D other)
  {
    ...
    this.xllcorner = other.xllcorner;
    this.yllcorner = other.yllcorner;
    this.cellsize = other.cellsize;
    this.NODATA_string = other.NODATA_string;
  ...
  */
  static public RasterDoubleGrid2D createFromFile ( String filename )
                                                               throws Exception
  {
  ...
  * @throws IOException
  */
  private void readDataFromFile(BufferedReader fin) throws IOException
  {
  ...
  * @throws IOException
  */
  private void writeFileHeader ( BufferedWriter out ) throws IOException
  {
    try
    {

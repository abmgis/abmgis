...
to setup-turtles
  ...
  ask turtles [
   set shape "sheep" ; Make them look like turtles
   setxy (random 20) (random 20) ; Set the turtle's x,y coord
   set color blue ; Set it's colour
  ]
end
...
to go
  ask turtles [
   ...
   if pcolor = green [
    set pcolor brown ; set the patch colour to brown (eat grass)
   ]
  ]
end
@#$#@#$#@

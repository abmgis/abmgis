---
title: "Statistics and Graphs for ABMGIS Book, Chapter 7"
...
# YOU WILL NEED TO CHANGE THIS SO THAT IT IS CORRECT FOR YOUR COMPUTER
setwd("/Users/nick/research_not_syncd/git_projects/abmgis/abmgis/Chapter09-SpatialStatistics/Resources")
...
```{r plotData, fig.width=9, fig.height=5}
# Some x values
...
```{r mapData, fig.width=9, fig.height=5}
...
The RSS for model 1 is `r print(rss1)` and for model 2 is `r print(rss2)`. It appears that model 2 is slightly better.
...
Nearest Neighbour Indices are:
 ...
 - Simulated1: `r simulated1.nni`
 - Simulated2: `r simulated2.nni`
...
It is based on the R code that is being developed as part of the [spatialtest](https://github.com/nickmalleson/spatialtest) project. For the most up to date version, see: https://github.com/nickmalleson/spatialtest/blob/master/r/expanding_cell.Rmd
...
```{r graph.multiscale.error-final, fig.width=5, fig.height=9}
r <- r2

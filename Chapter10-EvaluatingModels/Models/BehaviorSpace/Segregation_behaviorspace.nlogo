...
@#$#@#$#@
<experiments>
  <experiment name="Segregation Parameter Space Search Exp1" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    ...
    <steppedValueSet variable="%-similar-wanted" first="30" step="5" last="80"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
